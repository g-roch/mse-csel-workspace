...
// Define a configuration structure to be used in the sysfs attributes
...
// Declare global variables for the configuration and a value
static struct skeleton_config config;
static int val;

// Define sysfs show and store functions for the 'val' attribute
...
// Create a device attribute for 'val' with read/write permissions
DEVICE_ATTR(val, 0664, sysfs_show_val, sysfs_store_val);
// ---

// Define sysfs show and store functions for the 'cfg' attribute
...
// Create a device attribute for 'cfg' with read/write permissions
DEVICE_ATTR(cfg, 0664, sysfs_show_cfg, sysfs_store_cfg);
// ---

// Define a buffer and device variables for the character device
...
// Define open and release functions for the character device
...
// Define read and write functions for the character device
